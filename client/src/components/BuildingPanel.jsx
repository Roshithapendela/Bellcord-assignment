                ...
                <div className="call-buttons">
                  {floor < totalFloors && (
                    <button className={`call-btn call-up ${hasUpRequest ? 'active' : ''}`}
                      onClick={() => handleCall(floor, 'up')} title={`Call Up from Floor ${floor}`} id={`call-up-${floor}`}>
                  ...
                  {floor > 1 && (
                    <button className={`call-btn call-down ${hasDownRequest ? 'active' : ''}`}
                      onClick={() => handleCall(floor, 'down')} title={`Call Down from Floor ${floor}`} id={`call-down-${floor}`}>
